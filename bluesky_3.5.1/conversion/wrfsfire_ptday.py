...
#
# Farren Herron-Thorpe 2016-08-23
...
lineOut = '"41069", "fake1", "45-120", "2810001H00", "SO2", "%s", 0.00001, 0, 23\n' % (fire_date)
fout.write(lineOut)
lineOut = '"41069", "fake1", "45-120", "2810001H00", "HFLUX", "%s", 1, 0, 23\n' % (fire_date)
fout.write(lineOut)
lineOut = '"41069", "fake1", "45-120", "2810001H00", "ACRESBURNED", "%s", 1, 0, 23\n' % (fire_date)
fout.write(lineOut)
