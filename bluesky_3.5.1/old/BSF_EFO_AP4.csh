...
rm -r -f $ORIGIN
date >> /data/airpact4/AIRRUN/${YYYYMMDD}00/LOGS/bluesky_job.log
$BS_DIR/bluesky -d ${YYYYMMDD}00Z -K no-archive defaultLAR >> /data/airpact4/AIRRUN/${YYYYMMDD}00/LOGS/bluesky_job.log
echo "BlueSky run complete" >>  /data/airpact4/AIRRUN/${YYYYMMDD}00/LOGS/bluesky_job.log
date >> /data/airpact4/AIRRUN/${YYYYMMDD}00/LOGS/bluesky_job.log
