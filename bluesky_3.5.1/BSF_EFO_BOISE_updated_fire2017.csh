...
set ORIGIN = /opt/bluesky/bluesky_3.5.1/updated_fire2017

# RUN BLUESKY after cleaning up the output space
#rm -r -f $ORIGIN
date >> $LOG_DIR/bluesky_job_updated_fire2017.log
$BS_DIR/bluesky -d ${YYYYMMDD}00Z -K no-archive defaultLAR_SFonly >> $LOG_DIR/bluesky_job_updated_fire2017.log
echo "BlueSky run complete" >>  $LOG_DIR/bluesky_job_updated_fire2017.log
date >> $LOG_DIR/bluesky_job_updated_fire2017.log

#Check if successful
if ( ! -e $ORIGIN/fire_locations_${YYYYMMDD}.csv ) then
...
cp $ORIGIN/fire_locations_${YYYYMMDD}.csv $BS_DIR/conversion/fire_locations.csv
