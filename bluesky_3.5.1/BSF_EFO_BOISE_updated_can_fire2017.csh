...
#Changed TARGET_DIR since virtual server can't access /fastscratch

#set TARGET_DIR  = /home/mfard/projects/BOISE/run/emis/fire_orl/transfer
#set LOG_DIR = /home/mfard/projects/BOISE/run/emis/fire_orl/transfer
set TARGET_DIR  = /home/airpact5/projects/BOISE/transfer
set LOG_DIR = /home/airpact5/projects/BOISE/transfer

mkdir -v -p $TARGET_DIR 

#set ORIGIN = $BS_DIR/output/${YYYYMMDD}00.1
set ORIGIN = /opt/bluesky/bluesky_3.5.1/updated_can_fire2017

# RUN BLUESKY after cleaning up the output space
#rm -r -f $ORIGIN
date >> $LOG_DIR/bluesky_job_updated_can_fire2017.log
$BS_DIR/bluesky -d ${YYYYMMDD}00Z -K no-archive defaultLAR_SFonly >> $LOG_DIR/bluesky_job_updated_can_fire2017.log
echo "BlueSky run complete" >>  $LOG_DIR/bluesky_job_updated_can_fire2017.log
date >> $LOG_DIR/bluesky_job_updated_can_fire2017.log

#Check if successful
if ( ! -e $ORIGIN/fire_locations_Canada_${YYYYMMDD}.csv ) then
...
cp $ORIGIN/fire_locations_Canada_${YYYYMMDD}.csv $BS_DIR/conversion/fire_locations.csv
...
#  fire_ptday_ptinv_virtualAreaHeatFlux.py
  write_kml.py

mv $BS_DIR/conversion/fire_locations.kml $TARGET_DIR/fire_locations_${YYYYMMDD}.kml
mv $BS_DIR/conversion/fire_locations.csv $TARGET_DIR/fire_locations_${YYYYMMDD}.csv
